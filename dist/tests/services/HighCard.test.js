...
describe('test functional of class HighCard', () => {
    it('should return High Pair', () => {
        const playerHand = new player_hand_1.HighCard([
        ...
        expect(result === null || result === void 0 ? void 0 : result.name).toBe(constants_1.PLAYER_RANK.HighCard);
        expect(result === null || result === void 0 ? void 0 : result.rank).toBe('Ace');
    });
    it('shoud return true cause first result greater than second result', () => {
        ...
        const result = playerHand.solve();
        const comparePlayerHand = new player_hand_1.HighCard([
            new models_1.Card(`10 ${constants_1.SUITS.Clubs}`),
            new models_1.Card(`4 ${constants_1.SUITS.Diamonds}`),
            new models_1.Card(`8 ${constants_1.SUITS.Spades}`),
            new models_1.Card(`6 ${constants_1.SUITS.Hearts}`),
