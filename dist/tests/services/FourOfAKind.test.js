...
describe('test functional of class FourOfAKind', () => {
    it('should return instance of Four of a Kind', () => {
        ...
        expect(result === null || result === void 0 ? void 0 : result.name).toBe(constants_1.PLAYER_RANK.FourOfAKind);
    });
    ...
    it('shoud return true cause first result greater than second result', () => {
        const playerHand = new player_hand_1.FourOfAKind([
            ...
            new models_1.Card(`2 ${constants_1.SUITS.Hearts}`),
            new models_1.Card(`King ${constants_1.SUITS.Hearts}`),
        ]);
        const result = playerHand.solve();
        const comparePlayerHand = new player_hand_1.FourOfAKind([
            new models_1.Card(`Queen ${constants_1.SUITS.Clubs}`),
            new models_1.Card(`Queen ${constants_1.SUITS.Diamonds}`),
            new models_1.Card(`Queen ${constants_1.SUITS.Spades}`),
            new models_1.Card(`2 ${constants_1.SUITS.Hearts}`),
            new models_1.Card(`Queen ${constants_1.SUITS.Hearts}`),
        ]);
