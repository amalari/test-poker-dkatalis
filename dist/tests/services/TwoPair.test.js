...
describe('test functional of class TwoPair', () => {
    it('should return Two Pair', () => {
        const playerHand = new player_hand_1.TwoPair([
        ...
        expect(result === null || result === void 0 ? void 0 : result.name).toBe(constants_1.PLAYER_RANK.TwoPairs);
    });
    ...
    it('shoud return true cause first result greater than second result', () => {
        ...
        const result = playerHand.solve();
        const comparePlayerHand = new player_hand_1.TwoPair([
